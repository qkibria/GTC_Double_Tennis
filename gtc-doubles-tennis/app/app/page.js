...
export default function GeneratePage() {
  ...
  // ---------- Restrict Generate page to admins only ----------
  ...
  if (!isAdmin) {
    return (
      <div>
        <h1>Generate Matches</h1>
        <p className="subtle">
          Access restricted — the Generate page requires admin access. Use the
          <a href="/record" style={{ color: "#d7c9e0", marginLeft: 6 }}>Record</a>
          or
          <a href="/stats" style={{ color: "#d7c9e0", marginLeft: 6 }}>Stats</a>
          pages instead, or <a href="/admin" style={{ color: "#d7c9e0" }}>log in as admin</a>.
        </p>
      </div>
    );
  }
